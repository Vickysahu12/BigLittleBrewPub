...
import mainImage from "../assets/image/sip.webp";
    ...
    <AnimatedSection>
      <section className="bg-white py-12 px-4 lg:px-16">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          {/* Text Section */}
          <div
            className="flex-1 text-center lg:text-left animate-fadeIn will-change-transform will-change-opacity"
          ...
          {/* Image Section */}
          <div
            className="flex-1 relative flex justify-center animate-fadeIn will-change-transform"
            style={{ animationDelay: "0.4s", animationFillMode: "forwards" }}
          >
            <img
              src={mainImage}
              alt="Queenshead Cafe Interior and Atmosphere"
              className="rounded-lg shadow-lg w-full lg:w-[80%] object-cover transition-transform duration-700 ease-out hover:scale-105"
              loading="lazy"
              decoding="async"
            />
          </div>
