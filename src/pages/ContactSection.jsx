...
import cafeImage from "../assets/image/ga6.webp";
    ...
    <AnimatedSection>
      <section className="relative w-full bg-white py-16 px-6 md:px-12 lg:px-20 overflow-hidden">
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Content */}
          <div
            className="space-y-5 animate-fadeIn will-change-transform will-change-opacity"
          ...
          {/* Right Image */}
          <div
            className="relative overflow-hidden rounded-lg shadow-2xl group animate-fadeIn will-change-transform"
            style={{ animationDelay: "0.4s", animationFillMode: "forwards" }}
          >
            <img
              src={cafeImage}
              alt="Queenshead Cafe Front View in Berwick"
