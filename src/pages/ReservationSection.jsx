...
import bgImage from "../assets/image/restro.jpg"; // Background image
  ...
  return (
    ...
    <section className="relative py-20 px-6 md:px-12 lg:px-20">
      ...
      <div className="relative z-10 container mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* Booking Form */}
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg shadow-xl p-8 w-full max-w-md mx-auto">
